...
โฟลเดอร์นี้ประกอบด้วยสคริปต์สำหรับดึงลิงก์ประวัติวาร์ป (Warp) และคำนวณ Pity ของเกม Honkai: Star Rail

## 📂 รายชื่อไฟล์
| ชื่อไฟล์ | คำอธิบาย |
| :--- | :--- |
| **1_GetLink.bat** | 🔑 **ขั้นที่ 1:** ค้นหาลิงก์ประวัติจากไฟล์ Cache และก๊อปปี้ลง Clipboard |
| **2_Calc_HSR_Character.bat** | 🧮 **ขั้นที่ 2 (ทางเลือก A):** คำนวณ Pity เฉพาะ **ตู้วาร์ปตัวละคร** |
| **2_Calc_HSR_All.bat** | 📊 **ขั้นที่ 2 (ทางเลือก B):** คำนวณ Pity **ทุกตู้** (ถาวร, Light Cone, ตัวละคร) |
...
เข้าไปที่หน้าวาร์ป (Warp) กดปุ่ม **ดูรายละเอียด (View Details)** แล้วเลือกแท็บ **ประวัติ (History)** รอให้รายการโหลดจนเสร็จ
...
เข้าไปที่โฟลเดอร์ที่ติดตั้งเกม Honkai: Star Rail:
...
#### 4️⃣ วางไฟล์
ก๊อปปี้ไฟล์ `data_2` มาวางไว้ในโฟลเดอร์ **StarRail** นี้ (ที่เดียวกับพวกไฟล์สคริปต์)
...
รันไฟล์ **`2_Calc_HSR_All.bat`** (แนะนำอันนี้) สคริปต์จะอ่านลิงก์จาก Clipboard และดึงข้อมูลให้อัตโนมัติ
