...
## 💰 v5.2.0 - ระบบวางแผนทรัพยากร (Resource Planner)
> *"เป้าหมายที่ปราศจากการวางแผน... ก็เป็นได้แค่คำอธิษฐาน"*

จิ๊กซอว์ชิ้นสุดท้ายมาถึงแล้ว! นอกจากจะพยากรณ์ดวงได้ (Simulator) ตอนนี้คุณสามารถพยากรณ์ **"กระเป๋าตังค์"** ตัวเองได้ด้วยเครื่องมือ **Savings Calculator**

![Savings Planner](../../screenshots/GUI_V5_Planner.png)

### ✨ ฟีเจอร์เด่น
*   **เครื่องมือคำนวณการดอง (F10):** เข้าใช้ได้ผ่านเมนู **Tools**.
    *   **นับถอยหลังวันเป้าหมาย:** เลือกวันที่ตู้หน้าจะมา โปรแกรมจะนับวันรอให้ทันที
    *   **กำหนดรายรับเองได้:** ไม่ว่าจะสายฟรี (60/วัน) หรือสายเติม (150/วัน) ก็กรอกตัวเลขเองได้อิสระ
    *   **รองรับทุกรายได้:** มีช่องกรอกยอดรวมสำหรับ **Abyss, Event, โค้ดแจก หรือ รีเซ็ต Shop** แบบเหมาเข่ง ทำให้ใช้งานได้ตลอดไปแม้เกมจะเปลี่ยนระบบแจกของ
*   **คำนวณ Real-Time:** พิมพ์ตัวเลขปุ๊บ ยอดรวมเปลี่ยนปั๊บ ไม่ต้องกดคำนวณซ้ำๆ
*   **เชื่อมต่อ Simulator:** พอกดเครื่องคิดเลขเสร็จ กดปุ่ม **"Open Simulator >"** เพื่อส่งยอดเพชรที่คำนวณได้ ไปรันดูโอกาสเกลือต่อได้ทันที!
