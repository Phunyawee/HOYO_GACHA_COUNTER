...
#### Step 1: เปิดโปรแกรม & เมนูหลัก 🎮
เมื่อเปิดโปรแกรมขึ้นมา คุณจะพบกับหน้าเมนูหลัก:
*   **เลือกเกม:** พิมพ์ `1`, `2`, หรือ `3`
*   **เปลี่ยนโหมดแสดงผล (Option):** พิมพ์ **`T`** เพื่อสลับระหว่างโชว์ **วัน/เวลา** หรือ **ลำดับที่ [No.]**

![Main Menu](./screenshots/Console_MainMenu.png)

#### Step 2: ลากไฟล์ใส่ 🖱️
เมื่อโปรแกรมถามหาไฟล์ ให้ **ลากไฟล์ `data_2`** ใส่เข้าไปในหน้าต่างสีดำ แล้วกด **Enter**

![Drag Drop](./screenshots/Console_DragDrop.png)

#### Step 3: เลือกตู้ 🔢
พิมพ์ **`0`** เพื่อดึงข้อมูล **ทุกตู้ (แนะนำ)** หรือเลือกเลขตู้ที่ต้องการ

![Banner Menu](./screenshots/Console_Menu.png)

#### Step 4: สรุปผล & ไปต่อ 🔄
เมื่อทำงานเสร็จแล้ว คุณสามารถเลือกได้ว่าจะทำอะไรต่อ:
*   **กด [ENTER]**: เพื่อเช็ค **เกมเดิมซ้ำทันที** (ไม่ต้องเสียเวลาเปิดใหม่)
*   **พิมพ์ [M]**: เพื่อกลับไป **เมนูหลัก** (เปลี่ยนเกม/เปลี่ยนโหมด)
...
```
หมายเหตุ: รูปแบบรายงานใน Discord จะเปลี่ยนตามโหมดที่คุณเลือกในหน้าจอ console (ถ้าคุณเลือกโหมด "No." ใน Discord ก็จะแสดงเป็น [No. XX] แทนวันที่เช่นกัน)
