...
ดับเบิลคลิกที่ไฟล์ **`.bat`** ของเกมที่จะเช็ค (เช่น `Run_ZZZ.bat`) หรือคลิกขวาที่ `HoyoWish.ps1` เลือก "Run with PowerShell"
...
#### Step 2: เลือกเกม & ตั้งค่าการแสดงผล 🔢
คุณจะพบกับหน้าเมนูหลัก:
*   **เลือกเกม:** พิมพ์ `1`, `2`, หรือ `3`
*   **เปลี่ยนโหมดแสดงผล (ไม่บังคับ):** พิมพ์ **`T`** แล้วกด Enter เพื่อสลับระหว่าง **"วัน/เวลา"** (ค่าเริ่มต้น) หรือ **"ลำดับที่"** (เช่น `[No. 50]`)
*   **ออก:** พิมพ์ `Q`

#### Step 3: เลือกตู้ที่จะเช็ค
...
**หลังจากทำงานเสร็จ:**
*   กด **ENTER**: เพื่อเช็ค **เกมเดิมซ้ำทันที** (เหมาะมากถ้าเพิ่งกดกาชาเพิ่ม แล้วอยากดูยอดอัปเดตเลย)
*   พิมพ์ **`M`**: เพื่อกลับไปหน้า **เมนูหลัก** (เปลี่ยนเกม หรือเปลี่ยนโหมดแสดงผล)
